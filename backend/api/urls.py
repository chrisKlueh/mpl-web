...
from .views import UserGroupCreate, HelloWorldView, UserList, UserDetail, DemoList, DemoDetail, InstanceList, InstanceDetail, FeedbackList, FeedbackDetail
...
urlpatterns = [
    ...
    re_path(r'users/([0-9]*)$', UserDetail.as_view()),
